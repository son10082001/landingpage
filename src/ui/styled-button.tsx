...
const buttonVariant = tv({
  base: 'inline-flex min-h-0 text-black cursor-pointer items-center justify-center text-base font-medium outline-none transition-all focus:outline-none disabled:cursor-not-allowed active:scale-85 scale-100 duration-400',
  variants: {
    variant: {
      solid: 'btn-primary disabled:text-opacity-disabled disabled:border-transparent disabled:bg-opacity-disabled',
      secondary:
